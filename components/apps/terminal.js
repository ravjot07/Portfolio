...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Front-end development", "React.js", "Javascript", "Typescript", "Express.js", "SQL", "MongoDB"],
            projects: ["ravjotsingh-personal-portfolio", ],
            interests: ["Software Engineering", "Open Source Plone", "Blockchain"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">ravjot@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/ravjot")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ravjot, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-ravjot":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-ravjot");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ravjot, todoist, trash, settings, sendmsg ]";
                }
                break;
